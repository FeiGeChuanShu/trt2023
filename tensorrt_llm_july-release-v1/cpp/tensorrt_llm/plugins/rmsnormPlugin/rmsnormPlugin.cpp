    ...
    const void* const* inputs, void* const* outputs, void* workspace, cudaStream_t stream) noexcept
{
    ...
    if (mType == DataType::kHALF)
    {
        ...
        invokeGeneralRmsNorm<half>(output, input, weight, mEps, m, n, stream);
    }
    else if (mType == DataType::kFLOAT)
    {
        ...
        invokeGeneralRmsNorm<float>(output, input, weight, mEps, m, n, stream);
    ...
    else if (mType == DataType::kBF16)
    {
        ...
        invokeGeneralRmsNorm<__nv_bfloat16>(output, input, weight, mEps, m, n, stream);
    }
#endif
