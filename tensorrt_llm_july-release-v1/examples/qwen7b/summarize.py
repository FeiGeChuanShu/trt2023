...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.tokenizer,
                                                ...
                                                padding_side='left')
    generate_config = GenerationConfig.from_pretrained(args.tokenizer,
                                                        trust_remote_code=True)
    tokenizer.eos_token_id = generate_config.eos_token_id
    tokenizer.pad_token_id = generate_config.pad_token_id
